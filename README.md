...
<head>
<title>Script HTML Untuk Ade Dena</title>
<meta name="description" content="HTML Feeldream Repl Co">
<!-- 
  Made with love by Rayys!
  
     
     Instagram: @mhmdal.aziz_
...
body::before{content:"\00A9  @mhmdal.aziz_ | @dede0_0dena";color:white;opacity:.5;font-size:10px;position:fixed;bottom:25px;right:25px;z-index:150}
...
section {position:relative;z-index:99;padding: 0;height: 100vh;display: flex; flex-direction: column;align-items:center;text-shadow: 0px 2px 2px rgba(0, 0, 0, .8);border-top:2px dashed #fff}
...
section.first{border-top:0 dashed #fff}
...
.stiker{box-shadow: 0 4px 30px rgba(255,255,255, 0.3);backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);width:90px;height:90px;background: rgba(255, 255, 255, 0.7);border: 1px solid rgba(255, 255, 255, 0.3);border-radius: 10%;padding:10px;margin-bottom:25px}
...
p{font-size:15px;font-family:var(--gaya-font2);line-height:1.5em;text-align:center}
...
#judulakhir{z-index:100;font-size:17px;font-family:var(--gaya-font2);transition:all .5s ease}
#kalimatakhir{z-index:100;margin-right:50px;margin-left:50px;font-size:14px;font-family:var(--gaya-font2);}
...
<body>
   ...
   <div class="overlay">
     <div class="loading-message">Hai Ade!<br>Tunggu dulu ya..</div>
   </div>

   <!-- Ganti Audio di sini -->
   <audio src="seandainya.mp3" id="linkmp3" class="sembunyi"></audio>
   
   <section class="first" onclick="playaud();">
       <div class="wp"><img src="https://feeldreams.github.io/pics/awan4.jpg"/></div>
       <img id="first_stiker" class="stiker fade-in" src="https://feeldreams.github.io/peach6.gif"/>
       <h1 class="title">Hey Ade!</h1>
       <p class="slide-up">Mas ada pesan untukmu,<br>dibaca sampai akhir ya ☺️</p>
  </section>
  
  <section>
      <div class="wp"><img src="https://feeldreams.github.io/pics/awan3.jpg"/></div>
      <h2 class="title">Ade Tau?</h2>
      <p class="slide-right">Seberapa beruntungnya Mas<br>saat bertemu <b class="lingkar">denganmu</b>?<br></p>
      <p class="flip"><i>Scroll terus ke bawah ya :)</i></p>
  </section>
  
  <section>
  	<div class="wp"><img src="https://feeldreams.github.io/pics/awan8.jpg"/></div>
      <img class="stiker fade-in" src="https://feeldreams.github.io/peachhug.gif"/>
      <h3 class="title slide-right">Mas Beruntung Bngt<br>Bisa Jadi Milikmu Adee ✨</h3>
      <p class="slide-up"><b class="lingkar">Ade</b> udah menjadi yang<br>terbaik buat Mas, <i>makasii yaa..</i></p>
  </section>
  
  <section>
  	<div class="wp"><img src="https://feeldreams.github.io/pics/awan1.jpg"/></div>
      <h4 class="title">Kalo Ade Tanya Kenapa<br>Mas Cuma Mau Sama Ade,</h4>
      <p class="slide-right">Singkat saja, karena Mas telah<br>menemukan <b class="lingkar">hal indah</b> saat<br>dekat denganmu..</p>
  </section>
  
  <section id="iniakhir">
  	<div class="wp" id="wpakhir"><img src="https://feeldreams.github.io/pics/awan6.jpg"/></div>
      <h1 id="judulakhir"></h1>
      <p id="kalimatakhir"></p>
  </section>
...
teksjudulakhir = "Terakhir,<br>Mas Mau Bilang:";
tekskalimatakhir = "Makasii udah hadir di hidupku,<br>Mas tau Ade punya dunia sendiri,<br>dan di situ bukan hanya Mas,<br>tapi Ade mau nerima Mas<br>apa adanya, <i>makasii yaa..</i><br><br><b><i>i'm very lucky to have u ✨</i></b><br><br><i>`ku harap sekarang, besok,<br>minggu depan, bulan depan,<br>tahun depan, dan seterusnya<br>kita akan selalu bersama..`</i><br><br><b>Stay with Me</b> Terus yaa! 🤍";
...
function katajudul(){
      ...
      strings: ["" + teksjudulakhir], startDelay: 50, speed: 55, cursor: true,
      afterComplete: function(){
      	judulakhir.innerHTML = teksjudulakhir;
          setTimeout(katakata,200);
      },}).go();
}
function katakata(){
	  new TypeIt("#kalimatakhir", {
      strings: ["" + tekskalimatakhir], startDelay: 50, speed: 50, cursor: true,
      afterComplete: function(){
...
function tes(){
  if(fungsi==0){
    initom.style.animation="jj .3s";
    window.scrollBy({top: tinggi,behavior: 'smooth'});
    fungsi = 1;
    setTimeout(smn,1000);
  }
}
  function smn(){fungsi=0}
